...
export function FlipCardDemo({ title = "BBPS Digital Business Card" }) {
  const [showWelcome, setShowWelcome] = useState(true);
  const [showCard, setShowCard] = useState(false);
  
  // Add debugging logs
  useEffect(() => {
    console.log("FlipCardDemo mounted");
    console.log("Initial state - showWelcome:", showWelcome, "showCard:", showCard);
    
    return () => {
      console.log("FlipCardDemo unmounted");
    };
  }, []);
        ...
        <div className="flex flex-col items-center justify-center">
            ...
            <AnimatePresence mode="wait">
              ...
              {showCard && (
                <motion.div
                  ...
                  onClick={handleInteraction}
                >
                  {/* Using our new FlipCard component */}
          ...
          <div className="text-center max-w-lg">
            <p className="text-gray-400">
              Interactive business card with flip effect. Click the flip button to see both sides.
            </p>
            <a
